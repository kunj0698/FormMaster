...
<body
	...
	<input type="hidden" id="FirstName" value="<%=session.getAttribute("FirstName") %>"/>
		...
		<!-- end topbar-main -->
			<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.tokrn}"/ >
								...
								<div class="row">
									...
									<div class="col-xl-4 col-lg-4 col-sm-4">
										<a href="javascript:void(0)"
											...
											class="fa fa-plus" id="addform" onclick="clear()" a></i> Add
											Form</a>
									</div>
								</div>
							</div>
				...
				<div class="col-xl-12 col-lg-12 col-sm-12 colmspadding">
					<div class="card mb-0">
						<div class="card-header">
							<div class="row">
								<div class="col-xl-8 col-lg-8 col-sm-8">
									<h5 class="mb-0 font-bold m-t-5" id="add" onclick="clear()">Add
										Form</h5>
								</div>
								<div class="col-xl-4 col-lg-4 col-sm-4">
									<a
										class="show_port_table btn btn-warning float-right btn-padding"
										id="back" onclick="clear()"><i class="fa fa-undo mr-1"></i>
										Move Back</a>
								</div>
							</div>
						</div>
											...
											<div
												...
												<div class="form-group">
													<label>Form #</label> <input type="text"
														class="form-control" readonly="" value="F0RM-01" id="form">
												</div>
											</div>
											<div
												...
												<div class="form-group">
													<label>Title Text (English) <span
														...
														class="form-control" id="titletext">
												</div>
											</div>
										...
										<div class="row pl-3 pr-3 pt-1">
											...
											<div
												...
												<div class="form-group">
													<label>Module <span class="text-danger">*</span></label> <select
														...
														data-live-search="true" id="module">
											...
											<div
												...
												<div class="form-group">
													...
													<select class="selectpicker"
														...
														data-live-search="true" id="characteristic"
														data-title="Select">
											...
											<div
												...
												<div class="form-group">
													...
													<select class="selectpicker"
														data-style="lineheight12 bg-transfer"
														data-live-search="true" id="subcharacteristic"
														data-title="Select">
											...
											<div
												...
												<div class="form-group">
													...
													<select class="selectpicker"
														data-style="lineheight12 bg-transfer"
														data-live-search="true" id="startmonth"
														data-title="Select">
														...
														<div class="form-group">
															...
															<div class="input-group date">
																<input type="text" class="form-control"
																	placeholder="dd/mm/yyyy" id="effectivedate"> <span
												...
												<div class="form-group">
													...
													<div class="custom-control custom-checkbox displayblock"
														...
														<input type="checkbox" class="custom-control-input"
															...
															class="custom-control-label mt-1" for="active"
										...
										<div class="row pl-3 pr-3 pt-1">
											<div class="col-xl-6 col-lg-6 col-sm-6 colmspadding">
												<div class="form-group">
													...
													<textarea class="form-control textareasize" id="text"></textarea>
												</div>
											</div>
										...
										<div class="form-actions m-t-5">
											<div class="text-center">
												<a
													...
													id="save"><i class="fa fa-floppy-o mr-2"></i>Save</a> <a
													class="show_port_table btn btn-danger text-white btn-padding ml-1" id="cancelform"><i
									...
									<table class="table table-striped nowrap mb-0">
										<tbody>
											...
											<tr>
												...
												<td class="border-0"><textarea id="description1"
											...
											<tr>
												...
												<td class="border-0"><select
													...
													data-style="lineheight12 bg-transfer"
													data-live-search="true" id="quetype"
											...
											<tbody>
												<tr>
													...
													<td class="border-0 p-1">
														<div class="form-group mb-0">
															<input type="text" class="form-control" id="single" name="singlechoice"
											...
											<tbody>
												<tr>
													...
													<td class="border-0 p-1">
														<div class="form-group mb-0">
															<input type="text" class="form-control"
																id="multilinetextbox" name="singlechoice"
																placeholder="Enter an answer choice in English">
														</div>
													</td>
											...
											<tbody>
												<tr>
													...
													<td class="border-0 p-1">
														<div class="form-group mb-0">
															<input type="text" class="form-control"
																id="singleselectdropdown" name="singlechoice"
																placeholder="Enter an answer choice in English">
														</div>
													</td>
											...
											<tbody>
												<tr>
													...
													<td class="border-0 p-1">
														<div class="form-group mb-0">
															<input type="text" class="form-control"
																id="multiselectdropdown" name="singlechoice"
																placeholder="Enter an answer choice in English">
														</div>
													</td>
										...
										<div
											...
											<div class="form-group mb-0 row pl-2 pr-2">
												...
												<div class="col-md-4 colmspadding">
													<input type="text" class="form-control"
														placeholder="DD/MM/YYYY" readonly id="dateformate">
												</div>
											</div>
										</div>
									</div>
												...
												<div class="col-xl-5 col-lg-4 col-sm-6 colmspadding">
													<div class="form-group">
														<select class="selectpicker answercombo"
															data-style="lineheight12 bg-transfer"
															data-live-search="true" id="AnswerType"
	...
	<script src="js/MasterForm.js"></script>
				...
				.DataTable(
						{
							...
							fnInitComplete : function() {
								$('div.toolbar1')
										.html(
												'<a href="javascript:void(0)" data-toggle="modal" data-target=".formsorting" class="btn btn-warning btn-padding mb-1 mr-1"><i class="fa fa-sort"></i></a><a href="javascript:void(0)" data-toggle="modal" data-target=".addformquestion" onclcik="modeladd()" id=addlower class="btn btn-warning btn-padding mb-1"><i class="fa fa-plus"></i> Add</a>');
							},
						});
	...
	/* 	$(".anstypecombo").change(function() {
		...
		$(".singlechoicetable").on("click", ".singlechoiceremove", function() 
				{
			var numRows = $('.singlechoicetable tr').length;
            if (numRows > 0) 
            {
		...
		$(".multichoicetable").on("click", ".multichoiceremove", function() {
	        	...
	        	var numRows = $('.multichoicetable tr').length;
	            if (numRows > 0) 
	            {
	                $(this).closest("tr").remove();
	            } 
		...
		$(document)
				.on(
						...
						".multichoiceadd",
						function() {
							var addNewRow = "<tr><td class='text-center border-0' width='5%'><i class='fa fa-arrow-right' aria-hidden='true'></i></td><td class='border-0 p-1'><div class='form-group mb-0'><input type='text'  id='single2' name='singlechoice' class='form-control' placeholder='Enter an answer choice in English'></div></td><td class='text-center border-0 p-0' width='3%'><a href='javascript:void(0)' class='multichoiceadd'><i class='fa fa-plus-square-o font_20 m-t-5 text-default' aria-hidden='true'></i></a></td><td class='text-center border-0 p-0' width='3%'><a href='javascript:void(0)' class='multichoiceremove'><i class='fa fa-minus-square-o font_20 m-t-5 text-default' aria-hidden='true'></i></a></td></tr>";
		...
		$(".singleselecttable").on("click", ".singleselectremove", function() {
	        	...
	        	var numRows = $('.singleselecttable tr').length;
	            if (numRows > 0) 
	            {
	                $(this).closest("tr").remove();
	            }
		...
		$(document)
				.on(
						...
						".singleselectadd",
						function() {
							var addNewRow = "<tr><td class='text-center border-0' width='5%'><i class='fa fa-arrow-right' aria-hidden='true'></i></td><td class='border-0 p-1'><div class='form-group mb-0'><input type='text'id='single3' name='singlechoice' class='form-control' placeholder='Enter an answer choice in English'></div></td><td class='text-center border-0 p-0' width='3%'><a href='javascript:void(0)' class='singleselectadd'><i class='fa fa-plus-square-o font_20 m-t-5 text-default' aria-hidden='true'></i></a></td><td class='text-center border-0 p-0' width='3%'><a href='javascript:void(0)' class='singleselectremove'><i class='fa fa-minus-square-o font_20 m-t-5 text-default' aria-hidden='true'></i></a></td></tr>";
		...
		$(".multiselecttable").on("click", ".multiselectremove", function() {
			...
			var numRows = $('.multiselecttable tr').length;
            if (numRows > 0) 
            {
                $(this).closest("tr").remove();
            } 
		...
		$(document)
				.on(
						...
						".multiselectadd",
						function() {
							var addNewRow = "<tr><td class='text-center border-0' width='5%'><i class='fa fa-arrow-right' aria-hidden='true'></i></td><td class='border-0 p-1'><div class='form-group mb-0'><input type='text' id='single4' name='singlechoice' class='form-control' placeholder='Enter an answer choice in English'></div></td><td class='text-center border-0 p-0' width='3%'><a href='javascript:void(0)' class='multiselectadd'><i class='fa fa-plus-square-o font_20 m-t-5 text-default' aria-hidden='true'></i></a></td><td class='text-center border-0 p-0' width='3%'><a href='javascript:void(0)' class='multiselectremove'><i class='fa fa-minus-square-o font_20 m-t-5 text-default' aria-hidden='true'></i></a></td></tr>";
