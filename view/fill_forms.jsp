                                        ...
                                        <div class="col-xl-3 col-lg-3 col-sm-6 col-xs-12 colmspadding">
                                            <div class="form-group mb-0">
                                                ...
                                                <select class="selectpicker" data-style="lineheight12 bg-transfer"
                                                    data-live-search="true" id="formName" data-title="Select" >
<!--  
                                    ...
                                    <div class="card mb-0 queshadow">
                                        <div class="card-body">
                                            <div class="row pl-2 pr-2 text-center">
                                                <div class="col-xl-12 col-lg-12 col-sm-12 col-xs-12 colmspadding">
                                                    <a class="btn btn-success btn-padding mr-2"  id="submitFillAnswer"><i
    ...
    <script>
        ...
        if($("#formName").val()!="")
        	{
        	PreviewQuestions($("#formName").val());
            $('.showformfill').slideDown();
            formtable.draw();
            $('.showformfill').addClass("d-block");
            $('.showformfill').removeClass("d-none");
        	}
        });
