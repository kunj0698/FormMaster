				...
				<div class="col-xl-12 col-lg-12 col-sm-12 colmspadding">
					<div class="card mb-0">
						<div class="card-header">
							<div class="row">
								<div class="col-xl-8 col-lg-8 col-sm-8">
									<h5 class="mb-0 font-bold m-t-5" id="add" onclick="clear()">Add Users</h5>
								</div>
								<div class="col-xl-4 col-lg-4 col-sm-4">
									<a
										class="show_port_table btn btn-warning float-right btn-padding" id="back"  onclick="clear()"><i
						...
						<div class="card-body pl-2 pr-2 pb-0 pt-0">
								...
								<div
									...
									<div class="btn btn-success text-white btn-padding mt-2"
										...
										<i class="fa fa-upload mr-2"></i> Upload <input type="file"
											id="file" accept="image/*" name="file"
								...
								<div class="col-xl-10 col-lg-9 col-sm-8 col-xs-12 colmspadding">
									...
									<div class="row pl-2 pr-2">
										...
										<div class="col-xl-2 col-lg-4 col-sm-4 col-xs-12 colmspadding">
											<div class="form-group">
												<label>Contact No.</label> <input id="contact" type="text"
										...
										<div class="col-xl-2 col-lg-4 col-sm-4 col-xs-12 colmspadding">
											<div class="form-group">
												...
												<select class="selectpicker" id="gender"
													...
													data-live-search="true" data-title="Select">
													<!--   <option value="" selected="selected">Select</option>
												...
												<div class="col-xl-6 col-lg-6 col-sm-6 colmspadding">
													<div class="form-group mb-0">
														...
														<div class="input-group date">
															<input id="validfrom" type="text" class="form-control"
																placeholder="dd/mm/yyyy" readonly> <span
													...
													<div class="form-group mb-0">
														...
														<div class="input-group date">
															<input type="text" class="form-control"
																placeholder="dd/mm/yyyy" id="validto" readonly> <span
																class="input-group-addon inputgroups"> <i
																class="mdi mdi-calendar"></i>
															</span>
														</div>
										...
										<div class="col-xl-2 col-lg-4 col-sm-4 col-xs-12 colmspadding">
											<div class="form-group">
												<label>Role<span class="text-danger ml-1">*</span></label> <select
													class="selectpicker" data-style="lineheight12 bg-transfer"
													id="role" data-live-search="true" data-title="Select">
													<!--  <option value="" selected="selected">Select</option>
                                                <option value="1">Admin</option>
                                                <option value="2">User</option> -->
												</select>
							...
							<div class="text-center border-top mt-1 pt-2 mb-2">
								<a
									...
									id="saveUser"><i class="fa fa-floppy-o mr-2"></i>Save</a> <a
									class="show_port_table btn btn-danger text-white btn-padding ml-1" id="cancle" onclick="clear()"><i
